...
| --- | --- | --- |
| macOS Apple Silicon | Ad-hoc-signed, unnotarized DMG/ZIP | Preview; one-time approval required |
| macOS Intel | Ad-hoc-signed, unnotarized DMG/ZIP | Preview; one-time approval required |
